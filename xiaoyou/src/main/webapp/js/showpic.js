function previewMultipleImage (file, id, MAXWIDTH , MAXHEIGHT) {
	MAXWIDTH =270;
	MAXHEIGHT =200;
	...
	if (file.files && file.files[0]) {
		...
		for(var i=0;i<file.files.length;i++){
			...
			reader.onload = function(evt) {
				div.innerHTML+='<img  id="img"'+i+' src='+ evt.target.result+'  style="float:left;width:'+MAXWIDTH+'px !important;height:'+MAXHEIGHT+'px !important;"/>';
			};
